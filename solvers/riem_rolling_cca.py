...
def RiemannianRollingCCA(loaderA, loaderB, p = 10, learning_rate = 1e-3, n_epochs=10, device = 'cpu', averaging=True, eps_regul=1e-3, per_epoch_log = True,lr_milestones=[40,60,80]):
