...
def RiemannianRollingICA(loader, mixing_true, p = 10, learning_rate = 1e-3, n_epochs=10, device = 'cpu', averaging=True, eps_regul=0, per_epoch_log = True,lr_milestones=[40,60,80],init_batch_size=1):
    ...
    optimizerICA = RiemannianGeneralizedStiefel((x,), lr=learning_rate,eps_regul=eps_regul) 
