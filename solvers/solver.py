...
class IterativeSolver(metaclass=abc.ABCMeta):
    '''
    Abstract base class setting out template for the iterative solver classes.
    Method list:
    '''

    def __init__(self, maxtime=1000, maxiter=1000, minobjective_value=-1e10, minreldecrease=1-1e-3, minreldecrease_shift = 15, mingradnorm=1e-8, minstepsize=1e-16,  maxcostevals=float('inf'), verbosity=1, logverbosity=1):
        """
